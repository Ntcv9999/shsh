...
buyers  = [872708541327224852]  #          
admins  = [872708541327224852]  #   ID users            
owners  = [872708541327224852]  #          
methods = ['HTTP-FLOOD', 'HTTP-RAW', 'HTTP-RAND', 'HTTP-SOCKET','CLOUDFLARE','UAM-BYPASS','SLOW'] # Methods
year_now= datetime.datetime.now().strftime("%Y")     
token   = 'MTA1OTMyNzQ0MzY3ODI2OTUxMA.GFdkhP.LjhTGBGqPcDG7bbudxYwm9MS_39DJvyngaCJec' # paste your token here
